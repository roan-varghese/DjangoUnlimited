...
class adminAdmin(admin.ModelAdmin):
    ...
    def get_urls(self):  
        custom_urls = [
            path('create_admin/', self.admin_site.admin_view(self.create_admin), name='A_create_admin'),
            
            path('edit_admin_profile', self.edit_profile, name='A_edit_admin_profile'),
            path('view_admin_profile', self.view_profile, name='A_view_admin_profile'),
        ]
        urls = super().get_urls()
