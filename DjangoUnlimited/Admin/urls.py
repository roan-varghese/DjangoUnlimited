...
urlpatterns = [
    ...
    path('export_stats_file/<int:users>/<int:students>/<int:current>/<int:alumni>/<int:employers>/<int:jobs_posted>/<int:apps>/<int:open_jobs>/<int:closed_jobs>/<int:deleted_jobs>', views.export_stats_file, name='export_stats_file')
]
